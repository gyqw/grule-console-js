...
export default class ComplexScoreCardTable {
    ...
    init(t) {
        ...
        t.append(n);
        this.remark = new Remark(n);
        var r = $("<div style='margin:5px 5px 5px 15px;'></div>");
        t.append(r), this.propertyContainer = $("<span>");
        ...
        this.table = $('<table class="table table-bordered" style="width: max-content;max-width: none;margin-left: 15px"/>');
        t.append(this.table);
        this.tbody = $("<tbody/>");
