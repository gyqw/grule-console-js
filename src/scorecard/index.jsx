...
$(document).ready(function (e) {
    ...
    const saveVersionButton = $(`<button type="button" class="btn btn-default disabled"><i class="rf rf-savenewversion"/> 保存新版本</button>`);
    ...
    window._setDirty = function () {
        ...
        saveVersionButton.html("<i class='rf rf-savenewversion'/> *保存新版本");
